...
class WebContractTests(unittest.TestCase):
    def test_main_log_and_sample_mailbox_copy_exist(self) -> None:
        ...
        self.assertIn('id="scope-action-archive"', html)
        self.assertIn('id="scope-action-email"', html)
        self.assertIn('id="action-confirm"', html)
        self.assertIn('id="action-toast"', html)
        self.assertIn('id="mail-accounts-list"', html)
        ...
        self.assertIn('id="tab-triage"', html)
        self.assertIn('id="triage-scope-select"', html)
        self.assertIn('id="triage-limit-per-bucket"', html)
        self.assertIn('id="triage-stale-days"', html)
        self.assertIn('id="triage-summary-length"', html)
        self.assertIn('id="refresh-triage-dashboard"', html)
        self.assertIn('id="reload-triage-scopes"', html)
        self.assertIn('id="triage-buckets"', html)
        self.assertIn('id="triage-message-detail-shell"', html)
        self.assertIn('id="triage-message-detail-body"', html)
    ...
    def test_log_ui_uses_final_and_not_no_undo(self) -> None:
        ...
        self.assertIn("getTriageDashboard", api_js)
        self.assertIn("createTriageBucketSummary", api_js)
