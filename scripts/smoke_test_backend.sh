...
echo "[11/14] Model options endpoint"
...
echo "[12/14] Model catalog endpoint"
...
echo "[13/14] Fake mail status endpoint"
...
echo "[14/14] Database reset endpoint"
